 ...
 * - 6 个 CRUD RPC（platform:dict:create/update/delete；全局字典仅超管）
 */
...
/** 创建字典类型（rpc_create_dict_type；platform:dict:create） */
...
/** 更新字典类型（rpc_update_dict_type；platform:dict:update） */
...
/** 更新字典数据项（rpc_update_dict_data；platform:dict:update） */
...
/** 删除字典数据项（rpc_delete_dict_data；platform:dict:delete） */
